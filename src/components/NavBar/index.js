  ...
  if (mobileNavVariant === 'variant-a') {
          ...
          <div className="absolute top-0 left-0 w-full z-10">
            <div className={classNames(secondaryColors, 'p-5 shadow-lg')}>
              <div className="flex items-center justify-between mb-6">
                {siteLogoLink({ title, isTitleVisible, logo })}
                <button aria-label="Close Menu" title="Close Menu" className="p-2 -mt-2 -mr-2 focus:outline-none" onClick={() => setIsMenuOpen(false)}>
    ...
    return (
      <div className="ml-auto lg:hidden">
        ...
        {isMenuOpen && (
          <div>
            <div className="fixed inset-0 bg-base-900 bg-opacity-50" onClick={() => setIsMenuOpen(false)} />
