  ...
  return (
    ...
    >
        ...
        {((props.title && props.isTitleVisible) || props.logo || props.text) && (
          <div className="sm:col-span-2">
            {((props.title && props.isTitleVisible) || props.logo) && (
              <Link href="/" aria-label={props.title} title={props.title} className="inline-block mb-6" data-sb-field-path=".title#@title .logo">
            ...
            {props.text && (
              <Markdown options={{ forceBlock: true }} className="lg:max-w-sm">
                {props.text}
              </Markdown>
            )}
          </div>
      ...
      <div className="flex flex-col-reverse justify-between pt-6 lg:flex-row">
        {props.copyrightText && (
          <p className="text-sm" data-sb-field-path=".copyrightText">
            {props.copyrightText}
          </p>
        )}
